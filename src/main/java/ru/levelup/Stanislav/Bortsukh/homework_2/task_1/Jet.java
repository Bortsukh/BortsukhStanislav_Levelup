...
public class Jet extends FuelType {
    public Jet(int passengersCapacity, int carryingCapacity, int distance, String model, String productionYear, int tankCapacity) {
